...
async def report_xlsx(trip_id: str, token: str,
    ...
    total = sum(e["amount"] for e in expenses)  # signed: refunds net the total down
    ...
    s4.append(["Date", "Category", "Description", "Amount", "Paid By",
               "Split Among", "Split Mode"])
    for r in build_transaction_rows(sorted_expenses, members):
        s4.append([r["date"], r["category"], r["description"],
