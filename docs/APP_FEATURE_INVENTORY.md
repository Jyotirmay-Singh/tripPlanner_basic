...
| Dashboard, spend ranking, category and member drill-downs | Implemented and verified | Home shows recent trips; trip Summary shows budget/spend, category donut, and entity spending bars; taps open category or payer histories | Home/Trips and Trip Summary; `GET /spend-summary` | [frontend/app/trip/[id]/index.tsx](../frontend/app/trip/[id]/index.tsx#L197), [backend/routes/spend.py](../backend/routes/spend.py#L11) | Spend/member/category helper and dashboard rendering tests passed | Live data loading was not exercised; spend ranking counts positive fronted amounts and excludes refunds |
