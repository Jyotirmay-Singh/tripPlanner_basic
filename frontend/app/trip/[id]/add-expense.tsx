...
export default function AddExpense() {
  ...
  // Per-family headcount overrides are no longer settable from the UI (the count picker is gone);
  // a new expense always uses each family's full registered size. Kept as a stable empty map so the
  // shared preview helpers (familyShareEach / splitPreviewLabel) keep their signatures.
      ...
      <FormScreen>
          <View style={{ width: '100%', maxWidth: CONTENT_MAX_WIDTH, gap: SPACING.md }}>
            ...
            <Card padding="lg" radius={RADIUS.xl}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'baseline', gap: SPACING.sm, marginTop: 6 }}>
                ...
                <Input
                  ...
                  errorTestID="ae-amount-precision"
            ...
            <Input
              ...
              placeholder="e.g. Dinner at The Leela"
            ...
            <View style={{ flexDirection: 'row', gap: SPACING.sm }}>
              <DateField
                ...
                label="Date *"
                value={dateDisplay}
                onChangeText={(value) => { setDateDisplay(value); setDateError(null); }}
                error={dateError}
